export const COMPANY = {
  ...
  address: {
    line1: 'Calle 70 entre 2 y 3 Nº 374',
    line2: 'La Plata, Buenos Aires',
    cp: 'CP 1900',
    full: 'Calle 70 entre 2 y 3 Nº 374, La Plata, Buenos Aires, Argentina, CP 1900',
  },
  mapsLink: 'https://www.google.com/maps/search/?api=1&query=Calle+70+entre+2+y+3+N%C2%BA+374,+La+Plata,+Buenos+Aires,+Argentina',
  mapsEmbed:
    'https://www.google.com/maps?q=Calle+70+entre+2+y+3+N%C2%BA+374,+La+Plata,+Buenos+Aires,+Argentina&output=embed',
  hours: [
